...
proposal = sampler.Multivariate_Normal_Sampler()
print model(startvalue)
print proposal.get_proposal(startvalue)
...
mcmcsampler.adjust_covariance(10000, 2)
mcmcsampler.proposalgenerator.save_covariance()
...
mcmcsampler.proposalgenerator.load_covariance()
